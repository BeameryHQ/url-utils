...
describe("getLinkType function", () => {
  it("should return a correct link type from a link URI", () => {
    assert.equal(
      urlUtils.getLinkType("http://facebook.com/ahmad.a.assaf").type,
      "social"
    );
    assert.equal(
      urlUtils.getLinkType("https://linkedin.com/in/ahmadassaf").type,
      "social"
    );
    assert.equal(
      urlUtils.getLinkType("https://wwww.linkedin.com/in/ahmadassaf").type,
      "social"
    );
    assert.equal(
      urlUtils.getLinkType("https://twitter.com/ahmadaassaf").type,
      "social"
    );
    assert.equal(
      urlUtils.getLinkType("https://google.com/ahmadaassaf").type,
      "website"
    );
    assert.equal(
      urlUtils.getLinkType("https://ahmadassaf.com/").type,
      "website"
    );
  });
  ...
  describe("getLinkType url pattern recognition", () => {
    it("should return a correct link pattern for a linkedin profile", () => {
      assert.equal(
        urlUtils.getLinkType("https://wwww.linkedin.com/in/ahmadassaf").pattern,
        "profile"
      );
      assert.equal(
